...
public:
	...
	ofxDropDown* setup(vector<string>& vals, int _maxTextLength=-1, float width = defaultWidth, float height = defaultHeight);
	ofxDropDown* setup(const string& dropdownName, vector<string>& vals, int _maxTextLength=-1, float width = defaultWidth, float height = defaultHeight);
